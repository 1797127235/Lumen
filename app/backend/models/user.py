...
class User(Base):
    ...
    user_type: Mapped[str] = mapped_column(String(30), default="student")  # student | transfer_student | graduate
...
class UserProfile(Base):
    ...
    school_level: Mapped[str | None] = mapped_column(String(30))  # 985 | 211 | double_first_class | normal
    ...
    target_company_level: Mapped[str | None] = mapped_column(String(20))  # top | major | medium | state_owned
    ...
    learning_style: Mapped[str | None] = mapped_column(String(20))  # video | reading | practice | mixed
    anxiety_level: Mapped[int | None] = mapped_column()
    preferred_interaction: Mapped[str | None] = mapped_column(String(10))  # chat | detailed | brief
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
