...
from backend.modules.agent.event_handlers import EVENT_HANDLERS
from backend.modules.agent.pydantic_agent import get_agent, get_agent_generation
from backend.modules.chat.persistence import _log_task_error, persist_turn, save_user_message
from backend.modules.chat.session import ensure_conversation, load_pydantic_history
...
async def stream_chat(
    ...
    from backend.modules.chat.lock import ConversationLock, LockCapacityError
    ...
    if conv.message_count >= 10 and conv.message_count % 10 == 0:
        from backend.modules.chat.summary import summarize_background
