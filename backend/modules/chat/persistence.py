...
from backend.modules.chat.models import Message
from backend.modules.chat.session import save_pydantic_history
...
async def persist_turn(
    ...
    from backend.modules.agent.pydantic_agent import get_agent_generation as _get_agent_generation
    ...
    if not state.cancelled and not deps.pending_event_ids:
        from backend.modules.memory.review_service import background_memory_review
